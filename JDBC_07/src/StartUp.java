...
public class StartUp {
	...
	public static void main(String[] args) throws SQLException {
		...
		// burada bildiğimiz sql sorgusu yazarak işlemlerimizi gerçekleştirebiliriz.Java
		// üzerinden sql çalıştırabilicez.
		...
		while (rs.next()) {
			...
			System.out.println(" ID: " + ogrenciID + ", Ogrenci No :" + ogrenciNo + ", Adi Soyadi :" + ogrenciAdi
					+ ogrenciSoyadi + ", Kullanici Adi : " + ogrenciUserName);
		...
		// ('19541547','melike24','Melike', 'Ova')";

		// Veri işleme işlemini doğrudan degerleri vermek yerine dolaylı yoldan
		// degerleri vericez .
		query = "INSERT INTO ogrenciler (ogrenciNo,userName,adi,soyadi) VALUES (?,?,?, ?)";
		...
		okulNo = sc.nextLine();
		System.out.print("Kullanici adı giriniz : ");
